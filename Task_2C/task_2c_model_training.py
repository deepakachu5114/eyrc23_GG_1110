...
train_generator = datagen.flow_from_directory(
    directory="/home/deepakachu/Desktop/eyantra/task2b/training_pixelated_resized",
    classes = class_names,
    target_size=(50, 50),
    batch_size=10,
    class_mode="binary",
...
valid_generator = datagen.flow_from_directory(
    directory="/home/deepakachu/Desktop/eyantra/task2b/validation_pixelated_resized",
    classes = class_names,
    target_size=(50, 50),
    batch_size=10,
    class_mode="binary",
...
test_generator = datagen.flow_from_directory(
    directory="/home/deepakachu/Desktop/eyantra/task2b/testing_pixelated_resized",
    classes = class_names,
    target_size=(50, 50),
    batch_size=10,
    class_mode="binary",
...
# ResNet50 model
resnet_50 = ResNet50(include_top=False, weights='imagenet', input_shape=(50,50,3))
...
model.save('/home/deepakachu/Desktop/eyantra/task2b/saved_models/model_pixelated_resized')
