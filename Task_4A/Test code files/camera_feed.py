...
os.makedirs("/home/deepakachu/Desktop/eyantra_stage_2/experimetation/frames_3_5_nitk", exist_ok=True)
os.makedirs("/home/deepakachu/Desktop/eyantra_stage_2/experimetation/frames_10_20_nitk", exist_ok=True)

# Save frames 3-5
for i, frame in enumerate(captured_frames_3_5):
    filename = f"/home/deepakachu/Desktop/eyantra_stage_2/experimetation/frames_3_5_nitk/frame_{i+1}.jpg"  # Naming each frame
...
for i, frame in enumerate(captured_frames_10_20):
    filename = f"/home/deepakachu/Desktop/eyantra_stage_2/experimetation/frames_10_20_nitk/frame_{i+10}.jpg"  # Naming each frame starting from 10
    cv2.imwrite(filename, frame)
