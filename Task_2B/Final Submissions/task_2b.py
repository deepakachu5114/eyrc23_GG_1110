...
*  any and all claim(s) that emanate from the use of the Sof11tware or
...
def classify_event(image):
    ...
    model = tensorflow.keras.models.load_model('/home/deepakachu/Desktop/eyantra/task2b/saved_models/model5')
